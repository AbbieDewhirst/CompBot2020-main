 ...
 */
class MoveAllInternalMotorsCommand
    : public frc2::CommandHelper<frc2::CommandBase, MoveAllInternalMotorsCommand> {
 public:
  MoveAllInternalMotorsCommand(ShooterSubsystemPID* shootersubsystemPID, ConveyorSubsystem* conveyorsubsystem, OrganizerSubsystem* organizersubsystem, TurretSubsystem* turretsubsystem, HoodSubsystem* hoodsubsystem);
