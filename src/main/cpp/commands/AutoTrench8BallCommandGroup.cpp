...
AutoTrench8BallCommandGroup::AutoTrench8BallCommandGroup(
    ...
    DriveStraightUsingGyroCommandV2(drivesubsystem, 215, 0.75, true, 24.0),
    IntakeSolOutCommand(conveyorsubsystem),
    DriveStraightUsingGyroCommandV2(drivesubsystem, -60, 0.75, false, 24.0),
    ...
    //WaitTimeCommand(0.5),
    DriveStraightUsingGyroCommandV2(drivesubsystem, -95, 0.75, false, 24.0),
    //WaitTimeCommand(0.5),
